...
const COUNTER_NAMESPACE = 'curiousad-portfolio';
...
const SESSION_FLAG = 'aditya_portfolio_session_viewed';
const CACHED_COUNT_KEY = 'aditya_portfolio_visitor_count';
  ...
  useEffect(() => {
    ...
    const recordVisit = async () => {
      try {
        ...
        if (isMounted) {
          const fallback = parseInt(localStorage.getItem(CACHED_COUNT_KEY) || '128', 10);
